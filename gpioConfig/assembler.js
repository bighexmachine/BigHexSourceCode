...
function assemble_wrapper(assembly, errorFunction, postCall){

   var m_insts = assemble(assembly+"\n", errorFunction);
   ...
   for (i = 0; i < m_insts.length-1; i += 2) {
     ...
     hexlArray.push(hex_byte(byte_low));
     hexuArray.push(hex_byte(byte_hi));
   }
   var num_words = i>>1;
...
module.exports = [];
module.exports.assemble = assemble_wrapper;
